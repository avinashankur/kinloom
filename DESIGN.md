...
- **Primary** (`{colors.primary}` — #1a3a3a): All primary CTAs. Deep teal-green for a distinctive accent.
...
| `{typography.body-lg}`           | 17px | 400    | 1.55        | 0              | Lead paragraphs, hero descriptions                          |
| `{typography.body-md}`           | 15px | 400    | 1.55        | 0              | Default running-text                                        |
| `{typography.body-sm}`           | 13px | 400    | 1.55        | 0              | Footer body, fine-print                                     |
